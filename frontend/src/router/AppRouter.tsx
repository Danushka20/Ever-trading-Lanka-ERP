...
import AreaDealerExplorer from "@/pages/dealers/AreaDealerExplorer"
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route path="/sales/edit-invoice/:invoiceId" element={<CreateInvoice />} />
          ...
          <Route path="/reports/profit-loss" element={<ProfitReport />} />
          
          {/* Others */}
          <Route path="/dealers" element={<Dealers />} />
          <Route path="/dealers/area-network" element={<AreaDealerExplorer />} />
